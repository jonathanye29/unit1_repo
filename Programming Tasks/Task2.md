# Programming Task 2: EV Calculator
    ...
    if option == 3:
        ...
        for line in ev_logs:
            if i > 0:
                ...
                total_time += temp_time
            i += 1
        print(f"{bold_green}Total charge time: {end_code}{colors[3]}{total_time // 60}hour(s) and {total_time % 60}minutes{end_code}")
